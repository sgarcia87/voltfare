...
function normalizePosition(p){
  ...
  $('#gpsDiagnostics').textContent='VoltFare · GPS v9 | hora recibida: '+String(raw)+' | formato: '+clockFormat+' | desfase: '+(age===null?'desconocido':age+' s')+' | precisión: '+String(p?.coords?.accuracy)+' m';
  return result;
}
